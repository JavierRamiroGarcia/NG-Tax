...
customized_database_generator.sh -d test_db.fa -t test_taxonomy.txt -k GTGCCAGC[AC]GCCGCGGTAA -p GGACTAC[ACT][ACG]GGGT[AT]TCTAAT -q ATTAGA[AT]ACCC[TCG][ATG]GTAGTCC -f primer_for_test_db -r primer_rev_test_db -x test_NG_Tax -o 71 -e 70
